...
function extract(): CaptureEntry | null {
  // Common Workday DOM markers
  const titleNode = document.querySelector('[data-automation="jobPostingHeader"] h1, h2[data-automation="jobTitle"]');
  const companyNode = document.querySelector('[data-automation="companyName"]') || document.querySelector('a[href*="myworkdayjobs"]');
  const locationNode = document.querySelector('[data-automation="locations"]') || document.querySelector('[data-automation="jobLocation"]');
  const postedNode = document.querySelector('[data-automation*="postedOn"], [data-automation*="Posted"]');
  const descriptionNode = document.querySelector('[data-automation="jobPostingDescription"]');
  const payNode = document.querySelector('[data-automation*="Pay Range" i], [data-automation*="Salary" i], [data-automation*="Compensation" i]');
